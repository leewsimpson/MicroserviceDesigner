...
function initMapper() 
{
  ...
  mapperDiagram.nodeTemplate = gojs(go.Node, //TreeNode
      ...
      gojs("TreeExpanderButton",  // support expanding/collapsing subtrees
        {
          width: 14, height: 14,
  ...
  mapperDiagram.groupTemplate = gojs(go.Group, "Auto",
      ...
      gojs(go.Panel, "Vertical",
        ...
        gojs(go.TextBlock,
          { font: "bold 12pt Segoe UI", margin: new go.Margin(5, 5, 0, 5), stroke:"DodgerBlue" },
          new go.Binding("text")),
...
function loadMapper(from:string, to:string, cb)
{
